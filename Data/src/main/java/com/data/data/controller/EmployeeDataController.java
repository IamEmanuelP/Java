...
public class EmployeeDataController 
{
	...
	{
		log.info("get types Start");

		EmployeeTypes employeeTypesList = new EmployeeTypes();

		EmployeeType employeeType1 = new EmployeeType();
		EmployeeType employeeType2 = new EmployeeType();

		List<EmployeeType> employeeList = new ArrayList<EmployeeType>();
		{
			employeeType1.setType("IT");
		}
		{
			employeeType2.setType("Manufacter");
		}

		employeeList.add(employeeType1);
		employeeList.add(employeeType2);

		employeeTypesList.setEmployeeTypeListList(employeeList);
