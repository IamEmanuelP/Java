...
public class AsyncService {
	...
	public CompletableFuture<EmployeeNames> getEmployeeName() throws InterruptedException 
	{
		...
		EmployeeNames employeeNameData = restTemplate.getForObject("http://localhost:8082/name", EmployeeNames.class);
	...
	public CompletableFuture<EmployeeAddresses> getEmployeeAddress() throws InterruptedException 
	{
		...
		EmployeeAddresses employeeAddressData = restTemplate.getForObject("http://localhost:8082/address", EmployeeAddresses.class);
	...
	public CompletableFuture<EmployeePhone> getEmployeePhone() throws InterruptedException 
	{
		...
		EmployeePhone employeePhoneData = restTemplate.getForObject("http://localhost:8082/phone", EmployeePhone.class);
